  ...
  return (
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 flex-grow">
        ...
        {/* Timer and warning */}
        {timeLeft > 0 ? (
          <div className="bg-blue-50 border border-blue-100 text-gray-700 p-4 rounded-md mb-6">
            <p>
              We're holding this table for you for {formatTime(timeLeft)}{" "}
              minutes
            </p>
          </div>
        ) : (
          <div className="bg-red-50 border border-red-100 text-gray-700 p-4 rounded-md mb-6">
            <p>
              You can still try to complete your reservation, but this table may
        ...
        >
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-4">
              If you're running late, you may text to communicate directly with
              our hosting team using the Caspimasa app to let us know, so that
              we can do our best to hold your table.
            </p>
            <p className="text-gray-600 mb-4">
              Cancelations made less than 2 hours before the reservation and
              no-shows may be subject to a fee of $10 per guest.
            </p>

            <h3 className="font-medium mb-2">Important dining information</h3>
            <p className="text-gray-600 mb-4">
              We have a 10 minute grace period. Please call us if you are
              running later than 10 minutes after your reservation time.
            </p>
            <p className="text-gray-600 mb-4">
          ...
          <div className="mb-6">
            <p className="mb-4">
              <span className="text-blue-500 font-medium">Sign in</span> to
              collect points for this reservation
            </p>
          ...
          <div className="mb-6">
            <p className="mb-4 text-gray-600">
              ...
              All credit card information will be processed securely. No-shows
              may be subject to a charge of $10 per person.
            </p>
            ...
            <button
              type="submit"
              className="w-full bg-blue-500 text-white font-medium py-3 px-4 rounded focus:outline-none hover:bg-blue-600 transition"
            >
